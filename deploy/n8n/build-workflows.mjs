...
function node({ id, name, type, typeVersion, position, parameters = {}, nodeCredentials }) {
  const value = { id, name, type, typeVersion, position, parameters };
...
return [{ json: {
  ...
  description: String(error.message || error.description || 'The n8n workflow failed.') +
