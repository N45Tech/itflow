...
The manifest reserves the next four feature IDs, one compatibility repair, and the release-safety hardening migration so concurrent branches cannot collide or leave fork migrations in upstream's namespace:
