...
| P1-03 — Cross-page UI consistency | **In progress** | Notification, Location, Quote, and Recurring Tickets workspace migrations are verified. Remaining legacy workspace batches and exception matrix are open. |
