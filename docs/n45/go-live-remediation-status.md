...
| P1-03 — Cross-page UI consistency | **In progress** | Notification and Location workspace migrations are verified by full validation runs [35737072218](https://github.com/N45Tech/itflow/actions/runs/35737072218) and [35739420942](https://github.com/N45Tech/itflow/actions/runs/35739420942). Remaining legacy workspace batches and exception matrix are open. |
