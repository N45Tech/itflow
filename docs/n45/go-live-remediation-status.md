...
| P1-03 — Cross-page UI consistency | **In progress** | Notification, Location, Quote, Recurring Tickets, and Recurring Invoices workspace migrations are verified. The Recurring Invoices batch also removes its saved-payment N+1 query. Fourteen legacy workspaces and the exception matrix remain open. |
