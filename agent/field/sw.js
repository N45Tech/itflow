...
const CACHE = 'n45-field-shell-v4';
const ASSETS = ['/js/field_device.js','/agent/field/shell.html','/agent/field/field.css','/agent/field/app.mjs','/agent/field/workspace.mjs','/agent/field/assistance.mjs','/agent/field/drafts.mjs','/agent/field/manifest.webmanifest','/agent/field/icon-192.png','/agent/field/icon-512.png','/assets/branding/n45-mark.svg'];
