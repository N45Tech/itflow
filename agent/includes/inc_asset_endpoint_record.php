...
<div class="card card-dark">
    <div class="card-header py-2">
        <h3 class="card-title mt-1"><i class="fas fa-fw fa-project-diagram mr-2"></i>Discovered Network State</h3>
        <div class="card-tools">
            <span class="badge badge-light"><?= count($endpoint_network_history) ?> historical</span>
        </div>
    </div>
    <div class="table-responsive">
        <table class="table table-sm table-striped table-borderless mb-0">
            ...
            <tr>
                <th>Interface</th>
                <th>Type</th>
                <th>MAC / IP history</th>
                <th>VLAN</th>
                <th>Switch / neighbor</th>
                <th>Source / Seen</th>
            </tr>
            </thead>
            <tbody>
            <?php if (!$endpoint_network_current) { ?>
                <tr><td colspan="6" class="text-center text-secondary py-3">No discovery source has reported network state yet. Manually maintained interfaces remain below.</td></tr>
            <?php } ?>
    ...
    <?php if ($endpoint_network_history) { ?>
        <div class="card-footer py-2">
            <a data-toggle="collapse" href="#endpointNetworkHistory<?= $asset_id ?>" role="button" aria-expanded="false" aria-controls="endpointNetworkHistory<?= $asset_id ?>">
                <i class="fas fa-fw fa-history mr-1"></i>View MAC, IP, VLAN, and neighbor history
            </a>
            <div class="collapse mt-2" id="endpointNetworkHistory<?= $asset_id ?>">
                <div class="table-responsive">
