...
<form action="post.php" method="post" autocomplete="off" data-itflow-submit>
            ...
            <div class="tab-pane fade" id="pills-client-notes<?= $client_id ?>">
                ...
                if ($config_module_enable_ticketing && !empty($sla_options)) { ?>
                    <div class="mb-3">
                        ...
                        <div class="row g-2">
                            <?php foreach (ticketPriorityDefinitions() as $sla_priority => $sla_definition) { $sla_current = $client_sla_assignments[$sla_priority] ?? 'default'; ?>
                                <div class="col-3">
    ...
    <div class="modal-footer">
        <button type="submit" name="edit_client" class="btn btn-primary text-bold" data-busy-label="Saving client…"><i class="fa fa-check me-2"></i>Save</button>
