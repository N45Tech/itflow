...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="bulk-client-impact">Impact</label>
                    <select class="form-select bulk-client-assessment" id="bulk-client-impact" name="bulk_impact" required>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="bulk-client-urgency">Urgency</label>
                    <select class="form-select bulk-client-assessment" id="bulk-client-urgency" name="bulk_urgency" required>
                        <?php foreach (ticketUrgencyDefinitions() as $key => $label) { ?>
                            <option value="<?= escapeHtml($key) ?>" <?= $key === 'medium' ? 'selected' : '' ?>><?= escapeHtml(ucfirst($key)) ?></option>
                        <?php } ?>
                    </select>
                    <small class="form-text text-muted">Priority: <strong id="bulk-client-priority">Medium</strong></small>
                </div>
            </div>
            <div class="col-md-4">
                <div class="mb-3">
        ...
        <script>
        (() => {
            const impact = document.getElementById('bulk-client-impact');
            const urgency = document.getElementById('bulk-client-urgency');
            const output = document.getElementById('bulk-client-priority');
