        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <select class="form-control select2" data-placeholder="- Select Tickets- " multiple name="tickets[]" required>
                    ...
                    $sql_tickets_select = mysqli_query($mysqli, "SELECT client_abbreviation, ticket_id, ticket_number, ticket_prefix, ticket_subject FROM tickets LEFT JOIN clients on ticket_client_id = client_id WHERE ticket_deleted_at IS NULL AND ticket_project_id = 0 AND ticket_closed_at IS NULL $client_ticket_select_query");
