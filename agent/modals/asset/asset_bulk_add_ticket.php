...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <select class="form-select select2" name="bulk_ticket_template_id" id="bulkAssetTicketTemplateSelect">
        ...
        <div class="mb-3">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="use_primary_contact" value="1" id="bulkAssetUsePrimaryContact">
                <label class="form-check-label" for="bulkAssetUsePrimaryContact">Use each asset client's active primary contact</label>
            </div>
