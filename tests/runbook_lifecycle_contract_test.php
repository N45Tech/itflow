...
// Canonical starter reconciliation must rebuild, validate and publish the two
// flagged runbooks idempotently, then pin project stages to those versions.
...
$assertTrue(substr_count($starter, "'publish_runbook' => true") === 2, 'Only onboarding and offboarding should be auto-published');
