...
<nav class="app-header navbar navbar-expand d-print-none" data-bs-theme="dark">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" data-lte-toggle="sidebar" data-enable-remember="TRUE" href="#" aria-label="Toggle navigation" title="Toggle navigation"><i class="fas fa-bars" aria-hidden="true"></i></a>
        </li>
    </ul>
