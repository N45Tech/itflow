    ...
    $ticket_templates = [
        ...
        [
            ...
            'tasks' => [
                ...
                ['Confirm Intune-capable licensing and supported Windows Pro, Enterprise or Education editions', 30],
                ['Deploy the N45 - Windows Client OS assignment-filter template', 15],
                ['Assign and remediate N45-05-Onboarding-Core', 30],
                ['Assign and remediate N45-20-Intune-Workstation', 45],
                ['Assign and remediate N45-30-Provisioning', 45],
                ['Assign and remediate N45-40-Applications', 45],
                ['Assign and remediate N45-50-Updates', 30],
                ['Verify leveldeploymentready, levelgroupid, s1deploymentready, s1siteid and s1sitetoken', 20],
                ['Register the pilot laptop in Windows Autopilot by OEM registration or hardware-hash import', 30],
                ['Verify Autopilot Production is assigned before OOBE; reset the device to OOBE when required', 20],
                ...
                ['Validate ESP installs Company Portal, LevelRMM, Microsoft 365 Apps and SentinelOne', 60],
                ['Verify Firefox, PuTTY and Visual Studio Code are available but not required', 15],
                ['Validate Entra join, Intune enrollment, BitLocker escrow, LAPS, Hello, compliance and updates', 60],
                ['After the pilot passes, assign and remediate N45-90-Drift', 20],
                ['Stage N45-10-Identity-CA separately after licensing, emergency-access and report-only review', 45],
