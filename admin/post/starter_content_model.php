...
function starterContentTicketTemplates() {
    ...
    $ticket_templates = [
        ...
        [
            ...
            'details' => '<p>Use the generated business-review snapshot as the agenda. Review exceptions, record decisions, and create separately owned work only when follow-up is needed.</p>',
            'tasks' => [
                ['Review service performance and unresolved work', 20],
                ['Review recurring issues, protection and recovery exceptions', 30],
                ['Confirm useful documents, contacts and upcoming renewals', 20],
                ['Record client decisions and the review outcome', 30],
                ['Create owned follow-up work and confirm the next review', 20],
            ],
        ],
        [
        ...
        [
            ...
            'tasks' => [
                ...
                [
                    'key' => 'ONB-020',
                    'name' => 'ONB-020 Kick off and understand the current environment',
                    'instructions' => 'Confirm primary, technical, billing and emergency contacts, escalation paths, locations, maintenance constraints, critical services, current providers, administrative access and known risks.',
                    'estimate' => 120,
                    'condition_type' => 'always',
                    'owner_type' => 'project_manager',
                    'due_offset_hours' => 24,
                    'evidence_type' => 'note',
                    'evidence_prompt' => 'Record attendees, contacts, access owners, critical services, known risks and the target handoff date.',
                    'depends_on' => ['ONB-010'],
                ],
                [
                    'key' => 'ONB-030',
                    'name' => 'ONB-030 Build the support record and connect in-scope tools',
                    'instructions' => 'Reconcile the client, locations, contacts, services, vendors and assets in ITFlow; attach the documents technicians need; and connect only the management, security and backup tools included in the agreement.',
                    'estimate' => 300,
                    'condition_type' => 'always',
                    'owner_type' => 'ticket_assignee',
                    'due_offset_hours' => 48,
                    'evidence_type' => 'any',
                    'evidence_prompt' => 'Attach or record the core client records, useful documents, connected tools, exclusions and unresolved mapping issues.',
                    'depends_on' => ['ONB-020'],
                ],
                [
                    'key' => 'ONB-040',
                    'name' => 'ONB-040 Validate the Microsoft 365 baseline when in scope',
                ...
                [
                    'key' => 'ONB-050',
                    'name' => 'ONB-050 Prove support readiness and complete the handoff',
                    'instructions' => 'Test alert routing, remote support, portal access, backup visibility and one agreed recovery check. Review supported services and open risks with the client, assign remaining work, and schedule the first business review.',
                    'estimate' => 120,
                    'condition_type' => 'always',
                    'owner_type' => 'project_manager',
                    ...
                    'initial_state' => 'Waiting',
                    'evidence_type' => 'note',
                    'evidence_prompt' => 'Record readiness checks, client acceptance, open work with owners, and the first review date.',
        ...
        [
            ...
            'tasks' => [
                ['Review service performance and unresolved work', 30],
                ['Review recurring issues, protection and recovery exceptions', 45],
                ['Confirm useful documents, contacts and upcoming renewals', 30],
                ['Hold the client conversation and record one clear outcome', 60],
                ['Create owned follow-up work and confirm the next review', 30],
            ],
        ],
        [
